          ...
          {isAuthenticated && (
            ...
            >
              <div className='mr-2 h-6 w-6 flex-shrink-0'>
                <img src={avtbeauty} alt='avatar' className='h-full w-full rounded-full object-cover' />
              </div>
        ...
        <div className='mt-4 grid grid-cols-12 items-end gap-4'>
          ...
          <form className='col-span-9'>
            <div className='flex rounded-sm bg-white p-1'>
              ...
              />
              <button className='flex-shrink-0 rounded-sm bg-red-600 py-2 px-6 hover:opacity-90'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
          ...
          <div className='col-span-1 justify-self-end'>
              ...
              renderPopover={
                <div className='relative  max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm shadow-md'>
                    ...
                    {/* <div className='mt-5'>
                      <div className='mt-2 flex py-2 hover:bg-gray-100'>
                        <div className='flex-shrink-0'>
                          <img
                            src='https://i.pinimg.com/236x/19/9f/4f/199f4f98da72b639f8d427dd95b4ade4.jpg'
                            alt='ảnh nè'
                  ...
                  <div className='flex h-[300px] w-[300px] flex-col items-center justify-center p-2'>
                    <img src={avtbeauty} alt='no purchase' className='h-30 w-30' />
            ...
            >
              <Link to='/' className='relative'>
                ...
                <span className='absolute top-[-5px] left-[17px] rounded-full bg-white px-[9px] py-[1px] text-xs text-orange '></span>
              </Link>
            </Popover>
          </div>
        </div>
